...
/* resources\js\components\App.svelte generated by Svelte v3.6.1 */



// (22:0) {#if mostrar}
function create_if_block(ctx) {
	var div_6, div_6_transition, current;

	return {
		c() {
			div_6 = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["element"])("div");
			div_6.innerHTML = `<ul class="collapsible"><li><div class="collapsible-header">Primero</div> <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div></li> <li><div class="collapsible-header">Segundo</div> <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div></li> <li><div class="collapsible-header">Tercero</div> <div class="collapsible-body"><span>Lorem ipsum dolor sit amet.</span></div></li></ul>`;
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(div_6, "class", "container");
		},

		m(target, anchor) {
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["insert"])(target, div_6, anchor);
			current = true;
		},
		...
		i(local) {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_render_callback"])(() => {
				if (!div_6_transition) div_6_transition = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["create_bidirectional_transition"])(div_6, svelte_transition__WEBPACK_IMPORTED_MODULE_1__["fly"], { x: -200, duration: 2000 }, true);
				div_6_transition.run(1);
			});
		...
		o(local) {
			if (!div_6_transition) div_6_transition = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["create_bidirectional_transition"])(div_6, svelte_transition__WEBPACK_IMPORTED_MODULE_1__["fly"], { x: -200, duration: 2000 }, false);
			div_6_transition.run(0);
		...
		d(detaching) {
			if (detaching) {
				Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["detach"])(div_6);
				if (div_6_transition) div_6_transition.end();
			}
		}
	};
}
...
function create_fragment(ctx) {
	var div, form, p, label, input, t0, span, t2, if_block_anchor, current, dispose;
	...
	return {
		...
		m(target, anchor) {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["append"])(div, form);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["append"])(form, p);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["append"])(p, label);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["append"])(label, input);

			input.checked = ctx.mostrar;
		...
		p(changed, ctx) {
			if (changed.mostrar) input.checked = ctx.mostrar;
			...
			if (ctx.mostrar) {
				...
				Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["transition_out"])(if_block, 1, () => {
					if_block = null;
				});
...
function instance($$self, $$props, $$invalidate) {
	document.addEventListener('DOMContentLoaded', function() {
		...
		var instances = M.Collapsible.init(elems, {acordeon : true});
 	});
	 
	let mostrar = true;

	function input_change_handler() {
		mostrar = this.checked;
		$$invalidate('mostrar', mostrar);
	}

	return { mostrar, input_change_handler };
}
...
__webpack_require__(/*! D:\RRVC\www\laravel-svelte\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\RRVC\www\laravel-svelte\resources\sass\app.scss */"./resources/sass/app.scss");
